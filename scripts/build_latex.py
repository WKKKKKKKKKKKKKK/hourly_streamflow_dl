...
def map_caption(d: dict) -> str:
    ...
    return (
        ...
        "is 1 in the middle and is marked. A pointed colourbar end means values lie "
        "beyond it. Every end is pointed except the top of $r$, where 1 is the ceiling "
        "of a correlation and nothing can exceed it. "
