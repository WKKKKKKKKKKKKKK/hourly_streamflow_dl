...
- `comparison_summary.csv`: compact side-by-side summary of the head-only best trials and train/val/test scores
...
The daily-branch transfer comparison, where only `lstm_hourly` is frozen, is stored separately at `../transfer_daily_to_hourly_partial_ft_s2_random30/daily_branch_transfer_comparison_summary.csv`.
